...
# CLASSES = ["severe_toxic", "obscene", "threat", "insult", "identity_hate"]
CLASSES = ["identity_hate"]
...
def main():
    ...
    models = train_folds(X_train, y_train, X_test, args.fold_count, args.batch_size, get_model_func)
    ...
    #     test_predicts = model.predict(X_test, batch_size=args.batch_size, verbose=1)
